...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 115.0, 53.0, 64.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 31.0, 40.0, 55.0, 20.0 ],
					"text" : "Bypass"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 95.0, 18.0, 72.0, 20.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.0, 235.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.0, 235.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 27.0, 171.0, 46.0, 50.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 71.0, 5.0, 48.0, 136.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 416.0, 120.0, 132.0, 31.0 ],
...
,
					"patching_rect" : [ 15.0, 114.0, 99.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 95.0, 53.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 44.0, 60.0, 20.0, 20.0 ],
					"varname" : "out_limiter"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 128.0, 150.0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-258" : [ "live.gain~[6]", "live.gain~", 0 ]
		}
,
		"dependency_cache" : [  ]
	}

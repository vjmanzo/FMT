...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 61.0, 119.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 102.0, 280.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 74.0, 280.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 72.0, 216.0, 46.0, 50.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 434.0, 5.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 31.0, 119.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 429.0, 37.0, 16.0, 78.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 215.0, 20.0, 82.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 379.0, 111.0, 53.0, 20.0 ],
					"text" : "Bypass"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 304.0, 127.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 391.0, 87.0, 20.0, 20.0 ],
					"varname" : "del_bypass"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 132.0, 20.0, 82.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 282.0, 111.0, 53.0, 20.0 ],
					"text" : "FB Filt"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 214.0, 63.0, 82.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 273.0, 50.0, 77.0, 20.0 ],
					"text" : "Mod Depth"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 214.0, 42.0, 82.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 203.0, 50.0, 66.0, 20.0 ],
					"text" : "Mod Rate"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 134.0, 119.0, 27.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 215.0, 12.0, 38.0, 38.0 ],
					"size" : 201.0,
					"varname" : "del_modrate"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 168.0, 119.0, 27.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 286.0, 12.0, 37.0, 37.0 ],
					"size" : 101.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 409.0, 37.0, 16.0, 78.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 236.0, 119.0, 27.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 286.0, 73.0, 37.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 131.0, 63.0, 82.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 372.0, 50.0, 66.0, 20.0 ],
					"text" : "Delay Mix"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 131.0, 42.0, 82.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 206.0, 110.0, 53.0, 20.0 ],
					"text" : "FB Amt"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 297.0, 63.0, 82.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 27.0, 91.0, 77.0, 20.0 ],
					"text" : "RHS Factor:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 297.0, 42.0, 82.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 27.0, 66.0, 77.0, 20.0 ],
					"text" : "Delay Time:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 20.0, 96.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 5.0, 156.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 270.0, 119.0, 27.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 382.843933, 13.0, 37.0, 37.0 ],
					"varname" : "del_mix"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 202.0, 119.0, 27.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 215.0, 72.0, 37.0, 37.0 ],
					"varname" : "del_fb"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 100.0, 93.0, 42.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 115.0, 91.0, 62.0, 20.0 ],
					"varname" : "del_rhs"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 115.0, 66.0, 62.0, 20.0 ],
					"varname" : "del_time"
				}
...
,
					"patching_rect" : [ 32.0, 159.0, 291.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 15.0, 447.0, 235.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 189.0, 130.0, 54.0, 38.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 481.0, 150.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 41.5, 106.0, 395.0, 106.0, 395.0, 22.0, 418.5, 22.0 ],
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 313.5, 106.0, 395.0, 106.0, 395.0, 22.0, 438.5, 22.0 ],
					"source" : [ "obj-36", 1 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-249" : [ "live.gain~[4]", "live.gain~", 0 ]
		}
,
		"dependency_cache" : [  ]
	}
